...
/**
 * The IGraph interface represents a graph data structure.
 *
...
public interface IGraph<K extends Comparable<K>, E> {
	 ...
	 * @param keyVertex1 the key of the first vertex
	 * @param keyVertex2 the key of the second vertex
	 * @return {@code true} if there is an edge between the vertices, false otherwise
	 ...
	 * @return ArrayList representing the shortest paths from the source vertex to all other vertices
	 */
	 ...
	 */
	ArrayList<Edge<K, E>> kruskal() throws GraphException;
